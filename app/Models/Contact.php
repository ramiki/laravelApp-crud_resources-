...
class Contact extends Model
{
  ...
  // created() : is a built-in event that is triggered by the Eloquent ORM when a new record is successfully created and saved to the database table associated with the model
  // $item : represents the Contact instance that triggered the created event, and it contains all the data
...
// The boot method is used to register an event listener for the created event. This event is fired(luched) whenever 
